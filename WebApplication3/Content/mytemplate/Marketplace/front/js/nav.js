        ...
        window.onscroll = function() {
          ...
          if (document.body.scrollTop >= 280 || document.documentElement.scrollTop >= 280) {
            ...
            myNavv.classList.add("sc");  
              document.getElementById('imgid').src = "@Url.Content("~/Content/mytemplate/")Marketplace/front/images/logo.png";  
          } else {
            myNav.classList.remove("scroll");
            myNavv.classList.remove("sc");  
              document.getElementById('imgid').src = "@Url.Content("~/Content/mytemplate /")Marketplace/front/images/top-logo.png";  
          }
        };
